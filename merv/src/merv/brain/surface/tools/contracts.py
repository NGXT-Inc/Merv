...
TOOL_MANIFEST: dict[str, ToolManifest] = {
    ...
    "sandbox.runs": ToolContract(
        ...
        description=(
            ...
            "wait_seconds. Each row also carries a signed `wait_url`: arm "
            "`merv-runs-wait --url <wait_url>` as a background process right "
            "after launching and the finished run wakes you, instead of the box "
            "billing idle until you next poll. "
