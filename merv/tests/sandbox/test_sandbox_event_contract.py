...
PUBLIC_SIGNATURES = {
    "request": "(self, *, experiment_id: 'str | None' = None, project_id: 'str | None' = None, gpu: 'str | None' = None, cpu: 'float | None' = None, memory: 'int | None' = None, time_limit: 'int | None' = None, instance_type: 'str | None' = None, region: 'str | None' = None, provider: 'str | None' = None, public_key: 'str | None' = None, public_key_override: 'str | None' = None, include_data_plane_enrichment: 'bool' = True, additional: 'bool' = False, sandbox_uid: 'str | None' = None) -> 'dict[str, Any]'",
    "request_from_data_plane": "(self, *, experiment_id: 'str | None' = None, public_key: 'str', project_id: 'str | None' = None, gpu: 'str | None' = None, cpu: 'float | None' = None, memory: 'int | None' = None, time_limit: 'int | None' = None, instance_type: 'str | None' = None, region: 'str | None' = None, provider: 'str | None' = None, additional: 'bool' = False, sandbox_uid: 'str | None' = None) -> 'dict[str, Any]'",
